...
//fetch the data using analytics.data.ga.get, which will return a rather large object with a ton of data.
//result.data.totalsForAlResults[metric], which is a string that is first converted to an integer before being returned in an object along with the start and end dates.
